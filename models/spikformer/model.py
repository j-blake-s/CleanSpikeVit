...
class SPS(nn.Module):
    ...
    def forward(self, x):
        ...
        x_rpe = self.rpe_bn(self.rpe_conv(x)).reshape(T,B,-1,H,W).contiguous()
...
class Spikformer(nn.Module):
    def __init__(self,
                 ...
                 embed_dims=256, num_heads=16, 
                 mlp_ratios=4, depths=2, timesteps=4):
        super().__init__()
        ...
        self.patch_embed = SPS(in_channels=in_channels,
